...
{
	return (en_u16x4(de_u16x4_a(a) + de_u16x4_a(b), de_u16x4_b(a)
			+ de_u16x4_b(b), de_u16x4_c(a) + de_u16x4_c(b), de_u16x4_d(a)
			+ de_u16x4_d(b)));
}
...
{
	return (en_u16x4(de_u16x4_a(a) / b, de_u16x4_b(a) / b, de_u16x4_c(a) / b,
			de_u16x4_d(a) / b));
}
